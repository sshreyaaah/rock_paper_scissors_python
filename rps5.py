...
#this updated version removes global varibales and use closures. it also solves the problem of now counting who won how many times occuring in last version.
