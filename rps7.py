...
#this updated version which converts our game file to a module so that it can be further used in other files as well.
...
def rps(): # afunction which wraps the whole play_rps and acts as a parent function.
    ...
    def play_rps(): #ek function create kiya hai which is responsible for playing game.
        ...
        print(f"\n Player wins:  {player_wins}") #output to print how many times player won the game.
...
rock_paper_scissors= rps() #rock_paper_scissors will store the return value of parent function rps().
