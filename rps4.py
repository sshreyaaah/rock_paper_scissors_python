...
#this updated version contains functions and recursions and scopes.
#the problem with this code is ki isme jo game_result or decide_winner wala function hai woh kaam nh kr rha hai meaning it is not displaying who won. This is not explained in the video so you need to look after this.
...
def play_rps(): #ek function create kiya hai which is responsible for playing game.
    ...
    print(game_result)
    global game_count #use the global variable game_count
    ...
    #we have typecasted game_count to string for concatenation purpose.
    print("\n Play again?")
    while True:
